...
import matplotlib.pyplot as plt # fix: ignore
import os
...
SAVE_DIR   = "../models/legal_bert_checkpoint"
RESULTS_DIR= "../results"
...
ax1.plot(epochs_range, train_losses, marker='o', color='blue')
ax1.set_title("Training Loss")
ax1.set_xlabel("Epoch")
ax1.set_ylabel("Loss")

ax2.plot(epochs_range, val_f1s, marker='o', color='green')
